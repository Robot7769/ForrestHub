...
// connected_admins
foresterLib.addEventListener('update_admins', (data) => {
    document.getElementById('connected_admins').innerText = data.count;
});
